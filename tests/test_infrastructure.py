...
async def test_article_repository_search(article_repository):
    ...
    article1 = Article(number="80", title="Увольнение", content="увольнение работника", chapter="Глава 13")
    article2 = Article(number="115", title="Отпуск", content="отпуск 28 дней", chapter="Глава 19")
